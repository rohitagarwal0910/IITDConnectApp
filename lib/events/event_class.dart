...
import 'package:iitd_connect_flutter/events/event_info/updates_class.dart';
...
class Event {
  ...
  factory Event.fromJson(Map<String,dynamic> json) {
    ...
    DateTime startDate = DateFormat('d/M/y hh:mm').parse(json["event"]["startDate"] + json["event"]["startTime"]);
    DateTime endDate = DateFormat('d/M/y hh:mm').parse(json["event"]["endDate"] + json["event"]["endTime"]);
    return Event(
      eventName: json["event"]["name"],
      eventBody: json["event"]["body"],
      imageLink: json["event"]["imageLink"],
      startsAt: startDate,
      endsAt: endDate,
      updates: json["event"]["updates"],
      about: json["event"]["about"]
    );
  }
}
